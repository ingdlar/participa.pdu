...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f1f1f1;">
    <center style="width: 100%; background-color: #f1f1f1;">
        ...
        <div style="max-width: 600px; margin: 0 auto;" class="email-container">
                ...
                <tr>
                    <td valign="middle" class="hero bg_white" style="padding: 3em 0 2em 0;">
                        <img src="{{ asset('images/logo.png') }}" alt=""
                            style="width: 180px; height: auto; margin: auto; display: block;">
                    </td>
                </tr>
                <tr>
                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                                        ...
                                        @if ($rol_id == 1)
                                            <h4>
                                                    Nos sentimos honrados de que hayas decidido formar parte como un Miembro de este Partido
                                                    que tiene el interés de luchar por un país digno para todos.
                                            </h4>
                                        @else
                                            <h4>
                                                Nos sentido honrados de que hayas decidido formar parte como Afiliado de este Partido
                                                que tiene el interés de luchar por un país digno para todos.
                                            </h4>
                                        @endif
                                    </div>
            ...
            <h2 style="margin: auto;">INFORMACION IMPORTANTE</h2>
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                style="margin: auto;">
                <tr>
                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            <td style="text-align: left; padding-left: 10px;">
                                                <h3 class="heading">CONTRASENA</h3>
                                                <h4>{{ $formattedPwd }}</h4>
                                            </td>
                                        </tr>
                                    </table>
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v652eace1692a40cfa3763df669d7439c1639079717194"
        ...
        data-cf-beacon='{"rayId":"6cca6280b88e826c","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.12.0","si":100}'
